...
public class FormTile {

    @Test
    public void formNavigation() throws InterruptedException {
        ...
        WebElement elementsTile = driver.findElement(By.xpath("//h5[contains(text(),'Forms')]"));
        elementsTile.click();

        //Wait for the page to load properly
        Thread.sleep(5000);
        String formtext = driver.findElement(By.xpath("//body/div[@id='app']/div[1]/div[1]/div[1]/div[1]")).getText();
        Assert.assertEquals(formtext, "Forms");
